...
CountdownTimer.prototype={
 initialize:function(elm,tl,mes) {
  ...
  if( ( this.tl - today ) > 0 ){
   timer += '<span class="number-wrapper"><div class="line"></div><div class="caption">ЧАСА</div><span class="number hour">'+hour+'</span></span>';
...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2021/01/01 00:00:00');
